...
export class AuthService {
  ...
  getToken(data: any) {
    ...
    return new Promise((resolve, reject) => {
      this.httpClient.post(this.url + "medico/api-token-auth/", data).subscribe(
        res => {
  ...
  getInfoPac(data: any): Observable<any> {
    ...
    return this.httpClient.get<any>(
      this.url + "paciente/getData?model=userPaciente&params=user_id=" + data
    );
  ...
  verifyUserEmail(data: any): Observable<any> {
    ...
    return this.httpClient.post<any>(
      this.url + "paciente/verificaUserEmail/",
      data
    );
  }
  ...
  getByUrlCustom(url): Observable<any> {
    ...
    return this.httpClient.get<any>(
      this.url + "agenda/getData?model=Agenda&params=" + url
    );
  }
  ...
  getInfoMedi(data: any): Observable<any> {
    ...
    console.log(data.jsonPk, " data");
    return this.httpClient.get<any>(
      this.url + "medico/getData?model=userMedico&params=user_id=" + data.jsonPk
    );
  }
  ...
  getInfoPaciente(data: any): Observable<any> {
    ...
    return this.httpClient.get<any>(
      this.url +
        "paciente/getData?model=userPaciente&params=user_id=" +
        data.jsonPk
    );
  }
  ...
  getMedics() {
    return new Promise((resolve, reject) => {
      this.httpClient
        .get(this.url + "medico/getData?model=userMedico")
        .subscribe(
          data => {
            resolve(data);
          },
  ...
  medicsByCity(city) {
    ...
    return this.httpClient.get(
      this.url + "medico/getData?model=userMedico&params=ciudad=" + city
    );
  }

  recoveryPassword(data: any): Observable<any> {
    return this.httpClient.post<any>(
      this.url + "paciente/emailResetMovil/",
      data
    );
  }
  ...
  getSpecialties() {
    return new Promise((resolve, reject) => {
      this.httpClient.get(this.url + "movil/getEspecialidades/").subscribe(
        data => {
          resolve(data);
        },
        err => {
    ...
    const observable = new Observable(observer => {
      this.socket.on("calendar", async (data: any) => {
        if (data.estadoCita !== "hold") {
          if (
            data.paciente.id === this.idPaciente ||
            data.paciente === this.idPaciente
          ) {
    ...
    const observable = new Observable(observer => {
      this.socket.on("calendar", async data => {
        if (
          ...
          data.medico === null ||
          data.medico === undefined
        ) {
          if (
            _data.medico_id === data.medico ||
          ...
          if (
            data.medico.id === this.user.id ||
            data.paciente.id === this.user.id ||
            _data.medico_id === data.medico.id
          ) {
            await this.getDayData(_data).then(d => {
              data.result = d;
  ...
  getMeetingAccepted(data) {
    ...
    return this.httpClient.get<any>(
      this.url +
        `agenda/getData?model=Agenda&params=paciente_id=${data.idPaciente},estadoCita=accepted,fecha=${data.fecha}`
    );
  }
  ...
  getMeetingData(idPaciente): Observable<any> {
    return this.httpClient.get<any>(
      this.url +
        this.urlGetInfo +
        "estadoCita=accepted,paciente_id=" +
        idPaciente
    );
  }
  ...
  deleteAppointment(idCita: any): Observable<any> {
    ...
    return this.httpClient.delete(
      this.url + "agenda/updateDiaryMedic/" + idCita + "/"
    );
  }
  ...
  update(data: any): Observable<any> {
    return this.httpClient.put<any>(
      this.url + "agenda/updateDiaryMedic/" + data.id + "/",
      data
    );
  }
  ...
  getIdMedicalHistory(idPaciente): Observable<any> {
    return this.httpClient.get<any>(
      this.url +
        "historial/getData?model=HistorialMedico&params=paciente_id=" +
        idPaciente
    );
  }

  //CONSULTAS NUEVO REGISTRO

  verificaInfoUsuario(cedula: string, digito: string): Observable<any> {
    console.log(cedula, digito);
    let vari = `${this.urlMongoDB}personas/getPersona/${cedula}/${digito}`;
    console.log(vari);
    return this.httpClient.get<any>(
      `${this.urlMongoDB}personas/getPersona/${cedula}/${digito}`
    );
  }

  verificaUser(data: any): Observable<any> {
    console.log("dataUser", data);
    return this.httpClient.post<any>(
      `${this.url}` + "paciente/verificaUser/",
      data
    );
  }
  ...
  // getIdUser(correo) {
  //   return this.httpClient.get<any>(
  //     this.url + "paciente/getIdUser/" + correo + "/"
  //   );
  // }
  ...
  getPrescription(dni): Observable<any> {
    return this.httpClient.get<any>(
      this.urlMongoDB + "receta/searchRecePac/" + dni
    );
  }
  ...
  searchPrescriptionDate(date: any, dni: any): Observable<any> {
    ...
    return this.httpClient.get<any>(
      `${this.urlMongoDB}receta/searchReceDate/${date},${dni}`
    );
  }
  ...
  getRecetasPaciente(identificacion) {
    ...
    return this.httpClient.get<any>(
      `${this.urlMongoDB}receta/searchRecePac/${identificacion}/`
    );
  }
  ...
  getInfoProducts(ids: any): Observable<any> {
    console.log(ids);
    return this.httpClient.get<any>(
      this.urlMongoDB + "inventario/listarInventarios/" + ids
    );
  }
  ...
  createCart(data: any): Observable<any> {
    ...
    return this.httpClient.post<any>(
      `${this.urlMongoDB}despacho/createCart`,
      data
    );
  }
  ...
  getDesp(ids: any): Observable<any> {
    return this.httpClient.get<any>(
      this.urlMongoDB + "despacho/searchDespa/" + ids
    );
  }

  getDespById(dni: any): Observable<any> {
    return this.httpClient.get<any>(
      this.urlMongoDB + "despacho/getDespaIdPac/" + dni
    );
  }
  ...
  createDispatch(data: any): Observable<any> {
    ...
    return this.httpClient.post<any>(
      `${this.urlMongoDB}despacho/crearDespa`,
      data
    );
  }
  ...
  getDispatchById(id: any): Observable<any> {
    ...
    return this.httpClient.get<any>(
      `${this.urlMongoDB}despacho/searchDespa/${id}`
    );
  }
  ...
  updatePrescriptionService(data: any): Observable<any> {
    return this.httpClient.put<any>(
      `${this.urlMongoDB}receta/updateReceta`,
      data
    );
  }
